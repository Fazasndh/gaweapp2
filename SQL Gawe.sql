...
-- Membuang struktur basisdata untuk db_gawee
CREATE DATABASE IF NOT EXISTS `db_gawee` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_gawee`;

-- membuang struktur untuk table db_gawee.applications
...
-- membuang struktur untuk table db_gawee.cache
...
-- membuang struktur untuk table db_gawee.cache_locks
...
CREATE TABLE IF NOT EXISTS `jobs` (
  ...
  `job_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Full-time',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- membuang struktur untuk table db_gawee.migrations
...
-- membuang struktur untuk table db_gawee.password_reset_tokens
...
-- membuang struktur untuk table db_gawee.personal_access_tokens
...
-- membuang struktur untuk table db_gawee.resumes
CREATE TABLE IF NOT EXISTS `resumes` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
  `job_title_qualification` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `location` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- membuang struktur untuk table db_gawee.sessions
...
-- membuang struktur untuk table db_gawee.users
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role` enum('seeker','company') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'seeker',
